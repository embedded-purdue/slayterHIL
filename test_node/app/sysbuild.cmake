...
add_dependencies(node_app node_app_remote)
sysbuild_add_dependencies(CONFIGURE node_app node_app_remote)

if(SB_CONFIG_BOOTLOADER_MCUBOOT)
  # Make sure MCUboot is flashed first
  sysbuild_add_dependencies(FLASH node_app_remote mcuboot)
endif()
