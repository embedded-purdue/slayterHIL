...
//     // Optional: ensure controller is configured (usually auto by DTS)
//     // i2c_configure(i2c, I2C_SPEED_SET(I2C_SPEED_STANDARD) | I2C_MODE_CONTROLLER);
...
// // --- Zephyr ESP32-S3 MASTER ---
// // Repeated-start write-then-read to Arduino slave (0x55)
